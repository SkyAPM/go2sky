...
// Source: github.com/powerapm/go2sky/reporter/grpc/language-agent-v2 (interfaces: TraceSegmentReportServiceClient)
...
import (
	context "context"
	language_agent_v2 "github.com/powerapm/go2sky/reporter/grpc/language-agent-v2"
